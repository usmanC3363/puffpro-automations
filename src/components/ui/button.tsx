  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap transition-colors focus-visible:outline-none  disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        secondary:
          " border border-black/20 dark:bg-secondary text-secondary-foreground shadow-sm dark:shadow-mycolors-white hover:bg-secondary/80",
        destructive:
          "bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90",
        outline:
          "border border-current rounded-[61px] shadow-xl  dark:shadow-sm hover:bg-accent hover:text-accent-foreground",
